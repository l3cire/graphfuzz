...
class BCCFuzzer(BaseFuzzer):
    ...
    def process_test_results(self, mutated_graph, tester: BCCTester, first_occurrence_times, total_bug_counts, timestamp):
...
if __name__ == "__main__":
    bcc_fuzzer = BCCFuzzer(num_iterations=50, use_multiple_graphs=True, feedback_check_type="regular")
    bcc_fuzzer.run()
